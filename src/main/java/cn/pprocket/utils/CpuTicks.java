...
public class CpuTicks {
    ...
    public CpuTicks(CentralProcessor processor, long waitingTime) {
        ...
        this.idle = tick(prevTicks, ticks, TickType.IDLE);
        this.nice = tick(prevTicks, ticks, TickType.NICE);
        this.irq = tick(prevTicks, ticks, TickType.IRQ);
        this.softIrq = tick(prevTicks, ticks, TickType.SOFTIRQ);
        this.steal = tick(prevTicks, ticks, TickType.STEAL);
        this.cSys = tick(prevTicks, ticks, TickType.SYSTEM);
        this.user = tick(prevTicks, ticks, TickType.USER);
        this.ioWait = tick(prevTicks, ticks, TickType.IOWAIT);
    }
    ...
    private static long tick(long[] prevTicks, long[] ticks, TickType tickType) {
